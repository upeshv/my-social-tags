...
<?php if($meta['1'] != ''){ ?>	<meta property="og:type" content="<?php echo $meta['1']; ?>" />   <?php } ?>
<?php if($meta['2'] != ''){ ?>		
	<meta property="og:description" content="<?php echo $meta['2']; ?>" />  <?php } ?>
<?php if($meta['3'] != ''){ ?> 				
	<meta property="og:audio" content="<?php echo $meta['3']; ?>" /> <?php } ?>
<?php if($meta['4'] != ''){ ?> 				
	<meta property="og:video" content="<?php echo $meta['4']; ?>" />  <?php } ?>
<?php if($meta['5'] != ''){ ?> 		
	<meta property="og:determiner" content="<?php echo $meta['5']; ?>" />  <?php } ?>
<?php if($meta['6'] != ''){ ?>   			
	<meta property="og:locale" content="<?php echo $meta['6']; ?>" />  <?php } ?>
<?php if($meta['7'] != ''){ ?>   
	<meta property="og:locale:alternate" content="<?php echo $meta['7']; ?>" />  <?php } ?>
